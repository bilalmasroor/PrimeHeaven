...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "azee.ecompulse@gmail.com", path: '/', icon: MailIcon },
                { text: "110 Raymond Rd", path: '/', icon: MapPinIcon }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="flex items-center">
                         <Image
                          src="/assets/primeheaven.png"
                          alt="Prime Heaven Logo"
                          width={140}
                          height={45}
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © primeheaven All Right Reserved.
                </p>
            </div>
        </footer>
    );
